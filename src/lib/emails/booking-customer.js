...
const LABELS = {
  es: {
    ...
    seeYou: "¡Nos vemos en Cartagena!",
    team: "El equipo de TUK TUK Cartagena",
  },
  en: {
    greeting: "Hi",
    ...
    seeYou: "See you in Cartagena!",
    team: "The TUK TUK Cartagena team",
  },
  de: {
    greeting: "Hallo",
    ...
    seeYou: "Bis bald in Cartagena!",
    team: "Das TUK TUK Cartagena Team",
  },
  fr: {
    greeting: "Bonjour",
    ...
    seeYou: "À bientôt à Cartagène !",
    team: "L'équipe TUK TUK Cartagena",
  },
};
...
export function getCustomerEmailHtml(booking) {
  ...
  const peopleText = booking.is_private
    ? l.private
    : `${booking.adults} ${l.adults}${booking.kids > 0 ? ` + ${booking.kids} ${l.kids}` : ""}`;
...
<tr><td style="border-top:1px solid rgba(248,246,241,0.15);padding:32px 0 24px 0;">
  <div style="font-size:11px;letter-spacing:0.28em;text-transform:uppercase;color:#C9A961;margin-bottom:12px;">${l.confirmed}</div>
  <div style="font-size:28px;font-weight:500;line-height:1.2;">${l.greeting}, ${booking.customer_name}!</div>
</td></tr>

<tr><td style="padding:24px 0;border-top:1px solid rgba(248,246,241,0.1);">
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td style="padding:8px 0;font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:rgba(248,246,241,0.5);width:120px;">${l.tour}</td>
      <td style="padding:8px 0;font-size:16px;">${TOUR_NAMES[booking.tour]}</td>
    </tr>
    <tr>
      <td style="padding:8px 0;font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:rgba(248,246,241,0.5);">${l.date}</td>
      <td style="padding:8px 0;font-size:16px;">${booking.date}</td>
    </tr>
    <tr>
      <td style="padding:8px 0;font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:rgba(248,246,241,0.5);">${l.time}</td>
      <td style="padding:8px 0;font-size:16px;">${timeLabel}</td>
    </tr>
    <tr>
      <td style="padding:8px 0;font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:rgba(248,246,241,0.5);">${l.people}</td>
      <td style="padding:8px 0;font-size:16px;">${peopleText}</td>
    </tr>
    <tr>
      <td style="padding:8px 0;font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:rgba(248,246,241,0.5);">${l.total}</td>
...
<tr><td style="padding:24px 0;border-top:1px solid rgba(248,246,241,0.1);">
  <div style="margin-bottom:16px;">
    <div style="font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:#C9A961;margin-bottom:4px;">${l.meetingPoint}</div>
    <div style="font-size:14px;color:rgba(248,246,241,0.7);">${l.meetingValue}</div>
  </div>
  <div style="margin-bottom:16px;">
    <div style="font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:#C9A961;margin-bottom:4px;">${l.whatToBring}</div>
    <div style="font-size:14px;color:rgba(248,246,241,0.7);">${l.whatToBringValue}</div>
  </div>
  <div>
    <div style="font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:#C9A961;margin-bottom:4px;">${l.questions}</div>
    <div style="font-size:14px;color:rgba(248,246,241,0.7);">${l.questionsValue} ${process.env.BUSINESS_EMAIL || "info@tuktukcartagena.com"}</div>
  </div>
</td></tr>

<tr><td style="padding:32px 0;border-top:1px solid rgba(248,246,241,0.1);text-align:center;">
  <div style="font-size:18px;font-weight:500;margin-bottom:8px;">${l.seeYou}</div>
  <div style="font-size:12px;color:rgba(248,246,241,0.5);">${l.team}</div>
</td></tr>
